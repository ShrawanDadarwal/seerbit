...
public class RecipientPOJO implements Serializable {
	...
	public String toString() {
		return "RecipientPOJO [name=" + name + ", address=" + address + ", mobile=" + mobile + ", accountnumber="
				+ accountnumber + ", bankcode=" + bankcode + ", idtype=" + idtype + ", idnumber=" + idnumber
				+ ", idexpiry=" + idexpiry + ", requiredfields=" + requiredfields + ", beneIDIssuedBy=" + beneIDIssuedBy
